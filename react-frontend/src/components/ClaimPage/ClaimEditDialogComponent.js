...
const ClaimCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("claim").patch(_entity._id, _data);
            props.onHide();
...
export default connect(null, mapDispatch)(ClaimCreateDialogComponent);
